...
- In flowcharts, use role-based colors with sufficient contrast. In sequence diagrams, rely first on participant labels, arrow semantics, and control blocks; do not force unsupported participant-specific styling. Avoid decorative gradients.
