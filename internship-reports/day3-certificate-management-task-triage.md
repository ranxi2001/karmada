...
| 图片 | 用途 | 说明 |
| --- | --- | --- |
| [现有证书管理数据流图](day3-karmada-certificate-management-current-data-flow.png) | 背景说明 | 解释当前内置证书生成、控制面证书使用链路和 agent 证书轮换链路 |
| [Karmada 证书管理方案数据流图](day3-karmada-certificate-management-proposal-data-flow.png) | 长期方案 | 展示未来可能的策略 API、controller、cert-manager 集成、多集群 Secret 分发、监控告警 |
| [Karmada 证书管理方案对比分析图](day3-karmada-certificate-management-comparison-data-flow.png) | review 对比 | 对比 built-in 方案和 cert-manager-layout 长期方案的差异、价值和边界 |
...
![Long-term certificate management data flow](https://raw.githubusercontent.com/ranxi2001/karmada/intern/internship-reports/day3-karmada-certificate-management-proposal-data-flow.png)
...
![Current vs proposed certificate management data flow](https://raw.githubusercontent.com/ranxi2001/karmada/intern/internship-reports/day3-karmada-certificate-management-comparison-data-flow.png)
