...
| P1 | 建立 Karmada CI flake 专项台账 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 11 固定窗口统计](day11-ci-flake-statistics.md)；[Day 27 可修复候选、实现与 fork CI](day27-pr7697-e2e-flake-root-cause-analysis.md)；[Day 33 #7791 新样本与 `karmadactl top` E4](day33-pr7791-e2e-flake-root-cause-analysis.md)；[`karmadactl top` flake PR #7795](https://github.com/karmada-io/karmada/pull/7795)；Remedy [issue #7776](https://github.com/karmada-io/karmada/issues/7776) 已 closed as completed，[PR #7777](https://github.com/karmada-io/karmada/pull/7777) 已合并为 `eb2e7c75ff82` | #7776/#7777 归档 DONE；等待 #7795 PR CI 与 human review；继续决定 migration `8ef8a08c6` 是否独立发布，并为其余未闭环 jobs 补 RCA，不开 timeout/retry 型 PR |
