...
| P1 | Review PR #7810 Binding update coalescing | REVIEW | 高 | 低 | 0.5 天 | [Day 41 代码与系统 review](day41-pr7810-binding-update-coalescing-review.md)；[英文评论草稿](day41-pr7810-review-comment.md)；[delayed-key race Mermaid](day41-pr7810-delayed-key-race.mmd)；head `31bef8d37` | 等用户确认 exact target/text 后发布 top-level review；核心 blocker 是 delayed key 越过 scheduler ownership/suspension，另需降级 `Fixes #7805`、收窄全局 failover/WR blast radius、明确 priority queue 语义并修复 command-line docs CI |
...
| P1 | 建立 Karmada CI flake 专项台账 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 11 固定窗口统计](day11-ci-flake-statistics.md)；[Day 27 可修复候选、实现与 fork CI](day27-pr7697-e2e-flake-root-cause-analysis.md)；[Day 33 #7791 新样本与 `karmadactl top` fixture/terminal evidence split](day33-pr7791-e2e-flake-root-cause-analysis.md)；[`karmadactl top` PR #7795](https://github.com/karmada-io/karmada/pull/7795)；[maintainer follow-up](https://github.com/karmada-io/karmada/pull/7795#issuecomment-5099607301)；Remedy [issue #7776](https://github.com/karmada-io/karmada/issues/7776) 已 closed as completed，[PR #7777](https://github.com/karmada-io/karmada/pull/7777) 已合并为 `eb2e7c75ff82` | #7776/#7777 归档 DONE；#7795 当前 `FIXTURE_LOCAL_E4 / TERMINAL_E2`，已回复 maintainer 并收紧 PR body，不再声称已证明 terminal 404 根因；等待 maintainer review，并观察 `/kind cleanup` 标签同步；继续决定 migration `8ef8a08c6` 是否独立发布 |
