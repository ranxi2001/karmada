...
| --- | --- | --- | --- | --- | --- | --- | --- |
| P0 | 9 月前拿到 AgentCube Karmada 项目社区席位 | DOING | 高 | 中 | 7-8 周 | upstream issue/PR/review/CI/会议材料证据链；每周 mentor 可检查总结 | Week 33 以 #7492 为核心，#7621/#7662 保持战略 review 线，#7697 保持交付维护线；每周至少沉淀 1 个 upstream-visible 证据 |
| P0 | 承接 #7492 multi-component scale rescheduling 的独立协作切片 | DOING | 高 | 高 | 1 周起 | [Day 42 承接/API/测试基线](day42-issue7492-multi-component-scale-rescheduling-intake.md)；`upstream/master@c884a959`；工作站 task lane 和精确英文评论草稿 | 经用户确认后向既有 owner `@mszacillo` 请求 API/兼容性/test matrix 独立切片；确认 ownership 前不建代码 worktree、不发重复 PR |
...
| P1 | 建立 Karmada CI flake 专项台账 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 11 固定窗口统计](day11-ci-flake-statistics.md)；[Day 27 可修复候选、实现与 fork CI](day27-pr7697-e2e-flake-root-cause-analysis.md)；[Day 33 #7791 新样本与 `karmadactl top` fixture/terminal evidence split](day33-pr7791-e2e-flake-root-cause-analysis.md)；[#7795 与 CI 分类](day33-karmadactl-top-flake-upstream-draft.md#upstream-ci-红项分类2026-08-10)；[maintainer follow-up](https://github.com/karmada-io/karmada/pull/7795#issuecomment-5099607301)；Remedy [issue #7776](https://github.com/karmada-io/karmada/issues/7776) 已 closed as completed，[PR #7777](https://github.com/karmada-io/karmada/pull/7777) 已合并为 `eb2e7c75ff82` | #7776/#7777 归档 DONE；#7795 保持 `FIXTURE_LOCAL_E4 / TERMINAL_E2`、已 `lgtm/approved`；唯一 CI 红项是与 PR 无关的 v1.35 kind cgroup-ready 启动失败，待 `/retest` 验证非确定性；继续决定 migration `8ef8a08c6` 是否独立发布 |
