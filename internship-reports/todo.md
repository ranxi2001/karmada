...
| P0 | 跟进 #7621 / proposal PR #7662 复杂工作负载安全重调度 | DOING | 高 | 高 | proposal 合同收敛后再估算实现 | [Day 15 尽调](day15-issue-7621-safe-rescheduling-feature.md)；[Day 29 #5070 / Full affinity 语义](day29-issue5070-pr7662-fresh-rescheduling-research.md)；[Day 30 maintainer API 方向](day30-pr7662-maintainer-api-direction.md)；[Day 31 API/开发方案](day31-workload-rebalancer-api-development-plan.md)；[Day 35 unavailable/Pending/workload 矩阵](day35-pr7662-workload-unavailable-pending-research.md)；[target-first review](https://github.com/karmada-io/karmada/pull/7662#discussion_r3576720182) | typed API 暂停。等待 maintainer 回应 `PreserveScheduled`；若继续讨论，先用 10 副本反例明确 Binding assigned、PodScheduled、Available 与长期 Unschedulable 的区别，并决定 Descheduler/WorkloadRebalancer 单一 writer 和 completion contract。SafeMigration、自动水位和 #7621 closing claim 继续排除 |
...
| P1 | 分析 Karmada 社区 issue / PR 动态 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 12 新 Issue / PR 机会扫描](day12-new-issue-pr-opportunities.md)；[Day 25 社区扫描](day25-karmada-community-scan-2026-07-17.md)；[Day 28 PR #6863 review](day28-pr6863-scheduler-health-review.md)；[Day 36 本周 review 候选](day36-karmada-weekly-review-candidates-2026-07-29.md)；[Day 36 PR #7800 深度 review](day36-pr7800-waiting-store-deep-review.md)；[Day 36 Issue #7802 确定性实验](day36-issue7802-priority-queue-experiment.md)；[#7802 queue-contract comment](https://github.com/karmada-io/karmada/issues/7802#issuecomment-5114587741)；[#7800 retained-memory review](https://github.com/karmada-io/karmada/pull/7800#discussion_r3671589022)；[#6863 line review](https://github.com/karmada-io/karmada/pull/6863#discussion_r3612379211)；[#7757 复现/review 评论](https://github.com/karmada-io/karmada/issues/7757#issuecomment-4953788174)；[#7692 review](https://github.com/karmada-io/karmada/pull/7692#pullrequestreview-4681354181) | #7800 等作者回应。#7802 评论已发布并确认 remote body 与本地原文一致；等待作者或 maintainer 明确 priority 合同，不先改代码、认领 Issue 或绑定 #7485。PR #7794 等作者更新后复查 |
