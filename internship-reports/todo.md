...
| --- | --- | --- | --- | --- | --- | --- | --- |
| P0 | 9 月前拿到 AgentCube Karmada 项目社区席位 | DOING | 高 | 中 | 7-8 周 | upstream issue/PR/review/CI/会议材料证据链；每周 mentor 可检查总结 | Week 33 以 #7492 为核心，先等明确 API 并做 Day 43 对照；#7621/#7662 保持战略 review 线，#7697 保持交付维护线 |
| P0 | 实现 #7492 multi-component scale rescheduling | BLOCKED | 高 | 高 | 1 周起 | 已 `/assign @ranxi2001`；[Day 42 承接与上下文基线](day42-issue7492-multi-component-scale-rescheduling-intake.md)；[Day 43 #5115 演进与快速实现路线](day43-issue5115-evolution-and-7492-implementation-plan.md)；`upstream/master@c884a959`；无关联 PR | 等 `RainbowMango` 明确 API；固定官方 ref 后对照 result/conversion/delta/failure/legacy/FRQ/RB-CRB 矩阵，对照前不建 worktree、不发旧评论 |
