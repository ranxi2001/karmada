...
| P0 | 实现 #7492 multi-component scale rescheduling | BLOCKED | 高 | 高 | 1 周起 | 已 `/assign @ranxi2001`；[Day 43 #5115 演进与快速实现路线](day43-issue5115-evolution-and-7492-implementation-plan.md)；`upstream/master@c884a959`；无关联 PR | 等 `RainbowMango` 明确 API；固定官方 ref 后对照 result/conversion/delta/failure/legacy/RB-CRB 矩阵，对照前不建 worktree、不发旧评论 |
