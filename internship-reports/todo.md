...
| --- | --- | --- | --- | --- | --- | --- | --- |
| P0 | 9 月前拿到 AgentCube Karmada 项目社区席位 | DOING | 高 | 中 | 7-8 周 | upstream issue/PR/review/CI/会议材料证据链；每周 mentor 可检查总结 | Week 33 以 #7492 为核心，先完成 Day 44 API 合同，再把源码实现与验证作为独立阶段推进；#7621/#7662 保持战略 review 线，#7697 保持交付维护线 |
| P0 | 实现 #7492 multi-component scale rescheduling | DOING | 高 | 高 | 1 周起 | 已 `/assign @ranxi2001`；[maintainer API 回复](https://github.com/karmada-io/karmada/issues/7492#issuecomment-5248383498)；[`Replicas int32` 疑问已撤回](https://github.com/karmada-io/karmada/issues/7492#issuecomment-5252661190)；[Day 42 上下文基线](day42-issue7492-multi-component-scale-rescheduling-intake.md)；[Day 43 演进记录](day43-issue5115-evolution-and-7492-implementation-plan.md)；[Day 44 纯 API 设计](day44-issue7492-component-scheduling-result-api-design.md)；`RainbowMango/pr_multi_component_next_move@c14af2f11`；`upstream/master@1c278577`；正文三项未勾选，无关联 PR | 以 Day 44 为 API 基线；后续从最新 canonical master 创建独立 worktree，另写调度行为和测试设计后再实现；旧协调评论不发 |
