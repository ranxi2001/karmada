...
| P0 | 实现 #7492 multi-component scale rescheduling | DOING | 高 | 高 | 1 周起 | 已 `/assign @ranxi2001`；[PR0 #7837](https://github.com/karmada-io/karmada/pull/7837) `76589a9d5`、[PR1 #7830](https://github.com/karmada-io/karmada/pull/7830) `6ff28fe4a`、[PR2 #7833](https://github.com/karmada-io/karmada/pull/7833) `98535c541`、[PR3 #7835](https://github.com/karmada-io/karmada/pull/7835) `782232b7d`；PR4 fork head `40d82879f`；[统一交接](issue7492-pr-stack-status.md#stack-overview) | 先分类 #7835 的 `e2e v1.35` 红灯；随后按 [exact draft](issue7492-pr-stack-status.md#pr4-upstream-draft) 单独确认并创建 PR4 Draft，真实 Flink E2E 留给可用集群或 upstream CI |
...
| P1 | 建立 Karmada CI flake 专项台账 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 11 固定窗口统计](day11-ci-flake-statistics.md)；[Day 27 可修复候选、实现与 fork CI](day27-pr7697-e2e-flake-root-cause-analysis.md)；[Day 33 #7791 新样本与 `karmadactl top` fixture/terminal evidence split](day33-pr7791-e2e-flake-root-cause-analysis.md)；[#7795 最终 RCA 与合并证据](day33-karmadactl-top-flake-upstream-draft.md#最终合并结论)；[Day 50 近期定时矩阵归并](day50-karmada-recent-e2e-failure-scan-2026-08-17.md)；Remedy [issue #7776](https://github.com/karmada-io/karmada/issues/7776) 已关闭，[PR #7777](https://github.com/karmada-io/karmada/pull/7777) 已合并为 `eb2e7c75ff82` | Day 50 已确认 Job status collection 在旧 member -> 新 API server、以及新 member -> 旧 API server v1.30 两个方向都确定性失败；先准备并确认新 issue exact text，跨版本终态合同未确认前不开无条件增删 condition 的 PR；etcd/Kind 继续按 artifact 归并 |
