...
| P1 | 实现 `karmadactl init` 证书轮换能力 | DOING | 中 | 中 | 1-2 天 | [Upstream issue #7693](https://github.com/karmada-io/karmada/issues/7693)；[Day 4 #7693 对齐](day4-certificate-layout-issue-follow-up.md#7693-方向纠偏从-secret-layout-转向证书轮换)；[Day 6 设计与实现准备](day6-certificate-rotation-design-implementation.md) | 从最新 `upstream/master` 新建干净分支，先抽取现有证书生成和 Secret 更新路径，再实现 `--cert-mode=rotate`；PR body 里明确 CA rotation 策略 |
