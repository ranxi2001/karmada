...
| P0 | 跟进 #7621 / proposal PR #7662 复杂工作负载安全重调度 | DOING | 高 | 高 | proposal 合同收敛后再估算实现 | [Day 15 尽调](day15-issue-7621-safe-rescheduling-feature.md)；[Day 29 #5070 / Full affinity 语义](day29-issue5070-pr7662-fresh-rescheduling-research.md)；[Day 30 maintainer API 方向](day30-pr7662-maintainer-api-direction.md)；[Day 31 API/开发方案](day31-workload-rebalancer-api-development-plan.md)；[Day 35 unavailable/Pending/workload 矩阵](day35-pr7662-workload-unavailable-pending-research.md)；[Day 37 selector / unschedulable 更新 review](day37-pr7662-selector-unschedulable-review.md)；[target-first review](https://github.com/karmada-io/karmada/pull/7662#discussion_r3576720182) | typed API 暂停。7 月 28 日会议仅收敛 offline workload scope；7 月 30 日 maintainer selector 方案能看见 assigned-but-unschedulable Pod，但仍需统一 Available/Unschedulable API 语义，定义 selector ownership/rollout、多组件到标量 deficit 的映射、`MultiplePodTemplatesScheduling` gate、scheduler/Descheduler ownership 和 completion contract。等待 `@zhy76` / `@RainbowMango` 回复或 proposal commit |
| P0 | 跟进 #5070 / #5172 multiple affinity Fresh reset | REVIEW | 高 | 中 | 等待 upstream CI / human review | [Day 29 调研](day29-issue5070-pr7662-fresh-rescheduling-research.md)；[Day 31 历史实现](day31-workload-rebalancer-api-development-plan.md)；[Day 34 mentor scope 纠偏、clean rebuild 与发布](day34-pr7791-mentor-scope-correction.md)；[Upstream PR #7791](https://github.com/karmada-io/karmada/pull/7791) current head `41ed65272` 为 3 文件 `+294/-13`、产品严格 `+6`，第一笔保留 #5425 Bharath authorship/date/连续 sign-off trailers，第二笔为 ranxi tests；full/race/compile/reverse validation 和 DCO 通过；[旧 scope comment](https://github.com/karmada-io/karmada/pull/7791#issuecomment-5053932300) 已标记 superseded | 等待当前 upstream checks 和真人 review，只处理有源码/测试证据的反馈；不让 scheduler 接管 cache freshness，不混入 #7662 typed/preserve API；按用户要求不评论 #5425 |
