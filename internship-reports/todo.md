...
| P0 | 跟进 #5070 / #5172 multiple affinity Fresh reset | REVIEW | 高 | 中 | 等待 upstream review | [Day 29 调研](day29-issue5070-pr7662-fresh-rescheduling-research.md)；[Day 31 设计、实现、验证与独立 review](day31-workload-rebalancer-api-development-plan.md)；[Day 32 scope 回复与泳道图](day32-pr7791-scope-response-draft.md)；[已发布 scope clarification](https://github.com/karmada-io/karmada/pull/7791#issuecomment-5053932300)；[Upstream PR #7791](https://github.com/karmada-io/karmada/pull/7791)；current head [`b2cf85aa30`](https://github.com/ranxi2001/karmada/commit/b2cf85aa3075f4975fe389c65bdd2e1d1648d65e) 为单个 signed-off commit、8 个文件；explicit multi-affinity request 使用 Most Recent Cluster snapshot，cache boundary 已在 builder 附近说明，scheduler tests 与 DCO 通过 | 新 upstream PR checks 已启动；等待真人 review，只处理有源码或测试证据的反馈。不接管 #5172，不混入 #7662 typed/preserve API |
