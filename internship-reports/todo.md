...
| P0 | 实现 #7492 multi-component scale rescheduling | DOING | 高 | 高 | 1 周起 | 已 `/assign @ranxi2001`；[maintainer API 回复](https://github.com/karmada-io/karmada/issues/7492#issuecomment-5248383498)；[Day 42 上下文基线](day42-issue7492-multi-component-scale-rescheduling-intake.md)；[Day 43 演进记录](day43-issue5115-evolution-and-7492-implementation-plan.md)；[Day 44 纯 API 设计](day44-issue7492-component-scheduling-result-api-design.md)；`RainbowMango/pr_multi_component_next_move@c14af2f11`；`upstream/master@1c278577`；无关联 PR | 以 Day 44 为 API 基线；后续从最新 canonical master 创建独立 worktree，另写调度行为和测试设计后再实现；旧协调评论不发 |
