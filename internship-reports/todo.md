...
| --- | --- | --- | --- | --- | --- | --- | --- |
| P0 | 9 月前拿到 AgentCube Karmada 项目社区席位 | DOING | 高 | 中 | 7-8 周 | upstream issue/PR/review/CI/会议材料证据链；每周 mentor 可检查总结；[#7492 PR stack 交接](issue7492-pr-stack-status.md) | 以 #7492 的 PR0-PR3 review/CI handoff 和 PR4 Draft 为核心；#7621/#7662 保持战略 review 线，#7697 保持交付维护线 |
| P0 | 实现 #7492 multi-component scale rescheduling | DOING | 高 | 高 | 1 周起 | 已 `/assign @ranxi2001`；[PR0 #7837](https://github.com/karmada-io/karmada/pull/7837) `76589a9d5`、[PR1 #7830](https://github.com/karmada-io/karmada/pull/7830) `6ff28fe4a`、[PR2 #7833](https://github.com/karmada-io/karmada/pull/7833) `98535c541`、[PR3 #7835](https://github.com/karmada-io/karmada/pull/7835) `782232b7d`；PR4 fork head `40d82879f`；[统一交接](issue7492-pr-stack-status.md#stack-overview)；[#7835 E2E RCA](day51-karmada-recent-pr-ci-e2e-failures-2026-08-17.md#7835等待-member-api-对象不等于-estimator-已看到它) | 观察 #7841 CI 与 PR0-PR3 review；#7835 底层同步原因待确认，不据单次红灯修改 PR3/PR4 产品代码；真实 Flink E2E 留给可用集群或 upstream CI |
