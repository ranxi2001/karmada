...
| P0 | 跟进 #7621 / proposal PR #7662 复杂工作负载安全重调度 | REVIEW | 高 | 高 | 本周主线，先拿到独立 review/test slice | [Day 15 尽调](day15-issue-7621-safe-rescheduling-feature.md)；[6 月 16 日文字稿](day22-karmada-meeting-2026-06-16-rescheduling-transcript.md)；[6 月 30 日全量转录与对齐](day23-pr7662-meeting-2026-06-30-transcript-and-alignment.md)；[Day 29 #5070 / Full affinity 语义](day29-issue5070-pr7662-fresh-rescheduling-research.md)；PreserveReady 8-case matrix、SafeMigration scheduler collision、direct-delete/finalizer falsification；[target-first review](https://github.com/karmada-io/karmada/pull/7662#discussion_r3576720182) 已发布 | 先请 proposal 明确 Full 只重置 replica assignment 还是也重置顶层 affinity cursor，并写清 Overflow/Duplicated 支持边界；再确认 Story 2 supported modes 与 Story 3 ownership/cancel 合同。任何新评论仍需用户确认 exact target/text |
| P0 | 跟进 #5070 / #5172 multiple affinity Fresh reset | DOING | 高 | 中 | 先协调 ownership，再决定 proposal/test/implementation | [Day 29 调研](day29-issue5070-pr7662-fresh-rescheduling-research.md)；[#5070 `/assign`](https://github.com/karmada-io/karmada/issues/5070#issuecomment-5022199800)，current assignee `@ranxi2001`；#5172 仍 assign `@bharathguvvala`；#5425 stale/blocked | 先准备一条窄英文协调稿，询问 #5172 在 v1.18 Overflow 后的剩余范围、Duplicated failback 和 clean replacement ownership；用户确认后再发，不直接写代码 |
...
| P1 | 建立 Karmada CI flake 专项台账 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 11 固定窗口统计](day11-ci-flake-statistics.md)；[Day 27 可修复候选、实现与 fork CI](day27-pr7697-e2e-flake-root-cause-analysis.md)；Remedy [issue #7776](https://github.com/karmada-io/karmada/issues/7776) / [PR #7777](https://github.com/karmada-io/karmada/pull/7777) 当前为单提交 `dcd150b17`，局部 E4、终态 no-op 反向测试与普通/race 包测试通过；current upstream v1.34 红灯为 post-test `CreateArtifact ETIMEDOUT`，273/273 E2E 全通过；migration `8ef8a08c6` exact-state wait 待单独发布决策 | #7777 代码无需修改，用户确认后只发 `/retest`；转绿后请求 human review。migration 仍需独立 exact-text 确认；其余未闭环 jobs 继续补 RCA，不开 timeout/retry 型 PR |
