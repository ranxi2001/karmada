...
| P1 | 建立 Karmada CI flake 专项台账 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 11 固定窗口统计](day11-ci-flake-statistics.md)；[Day 27 可修复候选、实现与 fork CI](day27-pr7697-e2e-flake-root-cause-analysis.md)；[Day 33 #7791 新样本与 `karmadactl top` fixture/terminal evidence split](day33-pr7791-e2e-flake-root-cause-analysis.md)；[#7795 最终 RCA 与合并证据](day33-karmadactl-top-flake-upstream-draft.md#最终合并结论)；[Day 50 近期定时矩阵归并](day50-karmada-recent-e2e-failure-scan-2026-08-17.md)；Remedy [issue #7776](https://github.com/karmada-io/karmada/issues/7776) 已关闭，[PR #7777](https://github.com/karmada-io/karmada/pull/7777) 已合并为 `eb2e7c75ff82` | Day 50 已确认 Job status collection 是未解决的 version-skew 缺陷，发布新 issue 前准备 exact text 并确认；etcd/Kind 失败继续按首个操作与 artifact 时间归并，不给受影响业务 spec 直接加 retry |
