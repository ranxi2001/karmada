...
| P1 | 跟进 EstimatorAssumption 跨 spec 清理 flake | REVIEW | 中 | 低 | 等待 upstream | [Issue #7826](https://github.com/karmada-io/karmada/issues/7826)；test-only [PR #7827](https://github.com/karmada-io/karmada/pull/7827) 为单 DCO commit `ba531a9a1`、3 文件 `+53/-23`；[Day 48 E3 RCA 与修复边界](day48-estimator-assumption-e2e-isolation-pr7827.md)；17/17 upstream checks 已通过 | 等 maintainer review；保持 E3，单次 current-SHA 全绿不升级为 E4。只在失败或 review 出现新信号时定向处理，不主动 retest/comment |
