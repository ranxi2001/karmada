...
| P1 | 分析 Karmada 社区 issue / PR 动态 | REVIEW | 中 | 低 | 0.5-1 天 | [Day 12 新 Issue / PR 机会扫描](day12-new-issue-pr-opportunities.md)；[Day 25 社区扫描](day25-karmada-community-scan-2026-07-17.md)；[Day 28 PR #6863 review](day28-pr6863-scheduler-health-review.md)；[Day 36 本周 review 候选](day36-karmada-weekly-review-candidates-2026-07-29.md)；[Day 36 PR #7800 深度 review](day36-pr7800-waiting-store-deep-review.md)；[#7800 retained-memory review](https://github.com/karmada-io/karmada/pull/7800#discussion_r3671589022)；[#6863 line review](https://github.com/karmada-io/karmada/pull/6863#discussion_r3612379211)；[#7757 复现/review 评论](https://github.com/karmada-io/karmada/issues/7757#issuecomment-4953788174)；[#7692 review](https://github.com/karmada-io/karmada/pull/7692#pullrequestreview-4681354181) | #7800 未发现 correctness blocker；常驻内存 finding 已明确为 non-blocking 并发布，等待作者回应或更新。Issue #7802 下一步用确定性 queue test 区分 capacity/quota 唤醒与 priority 排序。PR #7794 等作者更新后复查，不重复 bot 已指出的问题 |
