...
- 2026-08-25：按 work-api #49/#66 的模式完成 Kubernetes/Go 依赖升级 `deps/kubernetes-1.36-go-1.26@cf1bfed`；`go.mod` L11-L16 已逐项 `>=` Karmada 对应版本。本地验证与 fork push CI 全部 success，apidiff 确认 generated `SharedInformerFactory` 新增 methods 对自定义实现 source-incompatible、旧入口保留；[upstream PR #74](https://github.com/kubernetes-sigs/work-api/pull/74) 已创建，exact head `cf1bfed`，初始 EasyCLA success，未发布额外 comment。[完整记录](internship-reports/k8s-go-update.md)
