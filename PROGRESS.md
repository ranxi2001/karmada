...
- 2026-08-14：复核 #7826 的 member1 反例：`targetClusterNames` 只是 RB 结果断言，Policy 候选仍是全部成员；[澄清 comment](internship-reports/day48-issue7826-target-cluster-clarification-comment-draft.md) 已量化 taint fixture 为 3 副本 x 10m，重排后三集群共 90m，而仅针对 member1 的 Flink 用例实际受外来 30m 影响；未发布。
