...
- 2026-08-14：复核 #7826 的 member1 反例并拆成两条待发布 comment：[target 语义](internship-reports/day48-issue7826-target-clarification-comment-1-draft.md)说明 Policy 候选仍是全部成员，[taint 规模](internship-reports/day48-issue7826-taint-scale-comment-2-draft.md)量化为 3 副本 x 10m、member1 实际受外来 30m 影响；未发布。
...
- #7826 两条补充 comment 等用户确认 exact target/text 后依次发布；#7827 current-SHA CI 已全绿，单次绿灯不升级为 E4，其余只按新信号处理。
