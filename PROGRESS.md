...
| 主线 | 当前状态 | 下一触发条件 |
| --- | --- | --- |
| [#7492 PR stack](internship-reports/issue7492-pr-stack-status.md#stack-overview) | #7833 `29474a636` 已合并为 `a8ad84cb5288`；合并前 v1.34/v1.36 E2E 通过，v1.35 为 etcd/control-plane collapse。#7841 公开 head `b2b27ad01` 已 Ready；本地 E2E 候选 `3bb0a304a` 尚未 push | 不再为已合并 #7833 重跑或改代码；决定 #7841 test-only 更新，rollout、admission、CRB 和自动 target-loss failover 仍是边界 |
