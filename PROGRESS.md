...
- 2026-08-25：完成 [#7846 / #7824 evidence-first review](internship-reports/pr7846-pr7824-evidence-first-review-2026-08-25.md)。#7846 exact head 在 `failed member + active member` 时生成 `Active>0 + Failed=True`，被 Kubernetes v1.35.2/v1.36.1 Job status validation 拒绝；#7824 exact head 漏删 LoadBalancer/Local 的 `healthCheckNodePort`，真实 v1.36.1 allocator 复现已占用端口拒绝，且新 E2E 对旧行为也会通过。四条 inline comment 与两个 `Request changes` 尚待用户确认，本轮未发布 upstream 评论。
