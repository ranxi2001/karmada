...
- #7492：#7830/#7835 尚无实质性 human review；公开 #7841 因包含已合并 #7833 commit 而冲突。干净候选只有 focused unit/controller 证据，仍缺当前 exact tree 的 live E2E、arbitrary-client admission validation、mixed-version rollout，以及 CRB、自动 target-loss failover、split-write 的 live 证据。
