...
- 2026-08-25：完成 [近期 Karmada Issue / PR review 候选扫描](internship-reports/karmada-recent-issue-review-scan-2026-08-25.md)。#7846 仍会在 `failed member + active member` 时生成 `Active>0 + Failed=True`，被 Kubernetes Job status validation 拒绝；#7824 漏删 LoadBalancer/Local 的 `healthCheckNodePort`，且新 E2E 对旧实现也会通过。两项均为当前 P0 review 候选；#7843 仅进入设计讨论，#7819 缺真实进程/Lease/PATCH 重叠证据。本轮未发布 upstream 评论。
