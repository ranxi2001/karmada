...
当前优先级：战略主线继续等待 #7621/#7662 合同收敛；本周新增 review 主线为 PR #7800，Issue #7802 先做确定性队列复现；同时维护 #7791、#7697、#7795 三条已发布交付线。
...
- 2026-07-28：按 maintainer 反馈收紧 [PR #7795](https://github.com/karmada-io/karmada/pull/7795) 的证据等级和 PR body，不再声称已经证明原 CI terminal 404 根因。
...
- #7800 在独立 review worktree 核对 waiting store 生命周期、事件竞态、selector 等价性和常驻内存；形成源码或测试证据后才准备 review 草稿。
