...
For technical-route HTML presentations, default to a fixed `1920×1080` stage that scales as one 16:9 canvas without mobile reflow, and keep navigation chrome from consuming slide height. The current preferred visual direction is Signal / Style C: navy and warm paper surfaces, antique-gold emphasis, hairline structure, high information density, and an explicit cross-slide narrative bridge.
